// Base applications container for Toit alpha.191 envelopes.
//
// The alpha.198 `base-apps.toit` additionally exposes the dock USB V3 bridge.
// Keep this entrypoint so the published base-apps.191 artifact remains available.
